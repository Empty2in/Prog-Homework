...
int main()
{
    ...
    try
    {
        ...
        if (numOfShape == 0)
        {
            throw std::exception("no known figures found in the file");
        }
        else
        {
            std::cout << "Testing sort function\n" << "Array befor sorting:\n";
        ...
        std::cout << "Composite after coping:\n";
        ...
        std::cout << &compose;
        std::cout << "First CompositShape: " << &compose << "\n";
        CompositeShape moveComp = std::move(compose);
        std::cout << "Composite after moving: " << &moveComp;
        std::cout << "\n-----------------------------------------\n\n";
    }
