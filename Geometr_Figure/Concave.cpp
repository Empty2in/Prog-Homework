...
//setters
void Concave::setPt1(const double& x, const double& y)
{
	pt_1.x = x;
	pt_1.y = y;
}
void Concave::setPt1(const point_t& pt)
{
	pt_1.x = pt.x;
	pt_1.y = pt.y;
}
void Concave::setPt2(const double& x, const double& y)
{
	pt_2.x = x;
	pt_2.y = y;
}
void Concave::setPt2(const point_t& pt)
{
	pt_2.x = pt.x;
	pt_2.y = pt.y;
}
void Concave::setPt3(const double& x, const double& y)
{
	pt_3.x = x;
	pt_3.y = y;
}
void Concave::setPt3(const point_t& pt)
{
	pt_3.x = pt.x;
	pt_3.y = pt.y;
}
void Concave::setPt4(const double& x, const double& y)
{
	pt_4.x = x;
	pt_4.y = y;
}
void Concave::setPt4(const point_t& pt)
{
	pt_4.x = pt.x;
	pt_4.y = pt.y;
}
...
//getters
point_t Concave::getPt1() const
{
	return pt_1;
}
point_t Concave::getPt2() const
{
	return pt_2;
}
point_t Concave::getPt3() const
{
	return pt_3;
}
point_t Concave::getPt4() const
{
	return pt_4;
}
